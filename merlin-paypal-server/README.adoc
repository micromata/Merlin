...
Please refer module `merlin-paypal` for a more detailed documentation including a guide step-by-step.
...
file by starting the server with the command line option `f <file>`.
...
==== Starting the server in your IDE
